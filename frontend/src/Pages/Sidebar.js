...
<label>Employees</label>
                ...
                <div style={{height:shwemp===true?"100px":"0px", width:"100%", backgroundColor:"whitesmoke", justifyContent:"center", display:"flex", flexDirection:"column", alignItems:"center",overflow:"hidden",transition:"0.2s"}}>
                <div className='sidebarcontent'>
                    <div className='icon'>
...
<label>Trainees</label>
                ...
                <div style={{height:shwtrn===true?"120px":"0px", width:"100%", backgroundColor:"whitesmoke", justifyContent:"center", display:"flex", flexDirection:"column", alignItems:"center",overflow:"hidden",transition:"0.2s"}}>
                <div className='sidebarcontent'>
                    <div className='icon'>
...
<label>Trainees Details</label>
                ...
                <div className='sidebarlabelp' onClick={()=>navigate("/TraineePro")}>
<label>Trainees Progress</label>
                </div>
                </div> 
                </div>
                <div className='sidebarcontent'>
...
<label>Employe Attendence Details</label>
                ...
                <div className='sidebarlabelp' onClick={()=>navigate("/Trainattendence")}>
...
<label>Recruitment</label>
                ...
                {/* <div className='sidebarcontent' style={{backgroundColor:"red"}}>
                <div className='icon'>
